...
public class Bow implements MouseListener, MouseMotionListener{
	...
	public Bow(int x, int y, double scale, double angle){
		...
		arrowLength = (int)(160*scaleFactor);
	...
	public void mouseReleased(MouseEvent e) {
		...
		// (vx, vy) proportional to the StretcFactor and depends on the angle.
		...
		Coordinator.arrow = new Arrow(arrowHeadX, arrowHeadY, vx, vy, arrowLength);
