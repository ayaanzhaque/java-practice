...
public class FancyDrawingBoard extends JPanel {
	...
	public void addMouseMotionListener(MouseMotionListener listener){ this.addMouseMotionListener(listener); }
	
	public void removeKeyListener(KeyListener listener){ frame.removeKeyListener(listener); }
	public void removeMouseListener(MouseListener listener){ this.removeMouseListener(listener); }
	public void removeMouseMotionListener(MouseMotionListener listener){ this.removeMouseMotionListener(listener); }
